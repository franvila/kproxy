...
public class Environment {
    ...
    // renovate needs helm chart localstack version set like localstack-X.Y.Z
    private static final String AWS_LOCALSTACK_CHART_VERSION_DEFAULT = "0.6.15".replace("localstack-", "");
